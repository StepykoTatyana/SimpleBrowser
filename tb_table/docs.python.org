...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" /><title>3.9.3 Documentation</title>
    ...
    <link rel="search" type="application/opensearchdescription+xml"
          title="Search within Python 3.9.3 documentation"
  ...
  <h1>Python 3.9.3 documentation</h1>
  <p>
  Welcome! This is the documentation for Python 3.9.3.
  </p>
